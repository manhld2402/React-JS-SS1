              ...
              <div className="row bg-white border-bottom d-none d-lg-flex">
                ...
                <div className="col-lg-5 text-right">
                  <div className="d-inline-flex align-items-center p-2">
                    <a className="btn btn-sm btn-outline-primary btn-sm-square mr-2" >
              ...
              <nav className="navbar navbar-expand-lg bg-white navbar-light p-0">
                ...
                <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                  <div className="navbar-nav mr-auto py-0">
                    ...
                    <a  className="nav-item nav-link">Practice</a>
                    <a  className="nav-item nav-link">Attorneys</a>
                    <div className="nav-item dropdown">
                      <a  className="nav-link dropdown-toggle" data-toggle="dropdown">Dropdown</a>
                      <div className="dropdown-menu rounded-0 m-0">
                        <a  className="dropdown-item">Menu Item 1</a>
                        <a  className="dropdown-item">Menu Item 2</a>
                        <a  className="dropdown-item">Menu Item 3</a>
                      </div>
                    </div>
                    <a  className="nav-item nav-link">Contact</a>
                  </div>
                  <a  className="btn btn-primary mr-3 d-none d-lg-block">Get A Quote</a>
                </div>
              </nav>
            </div>
          </div>
