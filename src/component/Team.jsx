        ...
        <div className="container py-5">
          ...
          <div className="row">
            <div className="col-12">
              <div className="bg-primary rounded" style={{height: '200px'}} />
                ...
                <div className="team-item text-center bg-white rounded overflow-hidden pt-4">
                  ...
                  <div className="team-img position-relative">
                    ...
                    <div className="team-social">
                      <a className="btn btn-outline-light btn-square mx-1" ><i className="fab fa-twitter" /></a>
                      <a className="btn btn-outline-light btn-square mx-1" ><i className="fab fa-facebook-f" /></a>
                      <a className="btn btn-outline-light btn-square mx-1" ><i className="fab fa-linkedin-in" /></a>
                    </div>
                  </div>
                </div>
                <div className="team-item text-center bg-white rounded overflow-hidden pt-4">
